...
The application layout provides a consistent visual structure matching the Tank Inspection design system.
...
The inspector MUST provide a flexible layout with viewer area and collapsible chat.

#### Scenario: Inspector displays viewer and chat
- **WHEN** the inspector is rendered
- **THEN** a viewer placeholder area takes the remaining space (flex: 1)
